...
Scoreboard.prototype.show = function(score){
    ...
    gameoverText = this.game.add.bitmapText(0,100, 'minecraftia', 'YOUR DIED.', 36);
    ...
    startText = this.game.add.bitmapText(0, 300, 'minecraftia', 'Tap to play agian! ', 16);
    startText.x = this.game.width / 2 - (startText.textWidth / 2);
    this.add(startText);

    if(isNewHighScore) {
        newHighScoreText = this.gamne.add.bitmapText(0, 100, 'minecraftia', 'New High Score!', 12);
